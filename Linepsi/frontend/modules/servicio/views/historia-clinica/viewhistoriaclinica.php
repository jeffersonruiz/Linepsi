                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'detail'=>function ($model, $key, $index, $column) use ($modelHistoria) {
                                 ...
                                 return Yii::$app->controller->renderPartial('/gestion-documental/indexparcial', ['searchModel' =>  $searchModelDocumento,
...
<div class="panel panel-primary">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo $modelHistoria->isNewRecord ? 'Registrar Historia Clinica' : 'ActualizarHistoria Clinica'?></h3>
    </div>
        ...
        <div class="container"> 
              ...
              <div class="col-sm-10">  
                ...
                <?php $form = ActiveForm::begin(); ?>
                  ...
                  <div class="row">                
                    ...
                    <div class="col-lg-12">
                        ...
                        <?= $form->field($modelHistoria, 'IdConcepto')->widget(SwitchInput::classname(), [
                                'type' => SwitchInput::RADIO,
                                'items' => [
                                    ['label' => 'Aprobado', 'value' => 1],
                                    ['label' => 'Reprobado', 'value' => 2],
                                    ['label' => 'Proceso Especial', 'value' => 3],
                   ...
                   <div class="row">
                     ...
                     <div class="col-lg-12">
                          <?= $form->field($modelHistoria, 'ObservacionesGeneral')->textarea([//'disabled'=>true,
                                                                                    'rows' => 6]) ?>
                     </div>
                ...
                <div class="form-group">
                    <?= Html::submitButton($modelHistoria->isNewRecord ? 'Registrar' : 'Actualizar', ['class' => $modelHistoria->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
                </div>
