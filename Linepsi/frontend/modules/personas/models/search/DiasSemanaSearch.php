...
use frontend\modules\personas\models\DiasSemana;

/**
 * DiasSemanaSearch represents the model behind the search form about `frontend\modules\personas\models\DiasSemana`.
 */
