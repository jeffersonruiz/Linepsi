...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'status', 'created_at', 'updated_at', 'rol_id', 'documento'], 'integer'],
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'primernombre', 'segundonombre', 'primerapellido', 'segundoapellido'], 'safe'],
        ];
    }
